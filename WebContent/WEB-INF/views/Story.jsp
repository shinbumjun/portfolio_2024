...
<div class="container">
    ...
    <div class="intro">
        <p>
		            ...
		            제 소개를 하자면 저는 <span class="highlight">[K-디지털 트레이닝]</span> 웹 서비스 기반 빅데이터 분석 및 <br/>
		            개발자 양성과정 국비지원 교육과 부트캠프 총 2번의 교육을 받았습니다<br/><br/>
		     ...
		     <span class="highlight">실업급여 챗봇 / 외교부 콜센터 유지 보수에 관련된 일</span>을 하였습니다.<br/><br/>
		            ...
		            그래도 나름 국비에서 <span class="highlight">팀을 이끄는 팀장을 맡았고 팀원들 끼리의 마찰을 조율</span>하고 각각의 파트를 나눠주는 등<br/>
		            팀장으로써 좋을 역활을 하였지만 회사를 다녀보고 실상을 열어보니 열심히 하는 척을 하였던것 같았습니다<br/>
		            코드를 보고 코드의 흐름을 볼 줄 몰랐고 에러가 터지면 브라우저랑 매칭해서 정확한 코드의 위치도 몰랐었기 때문에<br/>
		            ...
		            그렇게 기본기가 없는 상태 마치 <span class="highlight">구멍이 뚫린 항아리에 물을 부어 봤자 </span>객체도 정확히 모르는 사람이 성장하기는 힘들었습니다<br/><br/>
		            
		            저는 요구사항을 제대로 구현할 줄 아는 개발자가 되고 싶었기 때문에<br/>
		            처음부터 제대로 공부하자는 마음으로 유투브의 자바의 정석 영상과 책을 보며 공부하였고 <br/>
		     <span class="highlight">더 나아가 자바 스터디를 열어 자바에 대해서 공부를 하였습니다</span><br/><br/>
		     
		            유튜브로 강의를 하는 강사분이 <span class="highlight">정석코딩 9기</span>를 모집한다고 해서 참여를 하였습니다<br/><br/>
		            
		            그 후로 완벽하다고는 못하지만 내가 원하는 기능들 <span class="highlight">비밀번호 찾기라든가 댓글 기능 구현</span>등<br/>
		            내가 구현하고 싶은 기능들을 스스로 구현해 내었고 중요한 것은 짧게 미친듯이 
		            열심히 불태워서 하는게 아니라 꾸준히 <br/>
